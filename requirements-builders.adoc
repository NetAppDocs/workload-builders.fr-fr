...
[role="lead"]
Assurez-vous que Workload Factory et AWS sont correctement configurés avant d'utiliser NetApp Workload Factory for Builders. Cela inclut vos identifiants de connexion AWS, un système de fichiers FSx pour ONTAP déployé, et plus encore.
